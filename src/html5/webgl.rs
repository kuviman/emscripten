...
pub type em_webgl_context_callback = Option<unsafe extern "C" fn(
...
extern "C" {
    pub fn emscripten_set_webglcontextlost_callback(
        ...
        userData: *mut c_void,
        useCapture: EM_BOOL,
        callback: em_webgl_context_callback) -> EMSCRIPTEN_RESULT;
    ...
    pub fn emscripten_webgl_make_context_current(
        context: EMSCRIPTEN_WEBGL_CONTEXT_HANDLE) -> EMSCRIPTEN_RESULT;
