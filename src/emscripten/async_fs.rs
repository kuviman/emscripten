...
pub type em_async_wget_onload_func = Option<
    unsafe extern "C" fn(*mut c_void, *mut c_void, c_int)>;
pub type em_async_wget2_onload_func = Option<
    unsafe extern "C" fn(*mut c_void, *const c_char)>;
pub type em_async_wget2_onstatus_func = Option<
    unsafe extern "C" fn(*mut c_void, c_int)>;
pub type em_async_wget2_data_onload_func = Option<
    unsafe extern "C" fn(*mut c_void, *mut c_void, *mut c_uint)>;
pub type em_async_wget2_data_onerror_func = Option<
    unsafe extern "C" fn(*mut c_void, c_int, *const c_char)>;
pub type em_async_wget2_data_onprogress_func = Option<
    unsafe extern "C" fn(*mut c_void, c_int, c_int)>;
pub type em_run_preload_plugins_data_onload_func = Option<
    unsafe extern "C" fn(*mut c_void, *const c_char)>;
...
extern "C" {
    ...
    pub fn emscripten_async_wget2(
        ...
        onprogress: em_async_wget2_onstatus_func) -> c_int;
    pub fn emscripten_async_wget2_data(
        ...
        onprogress: em_async_wget2_data_onprogress_func) -> c_int;
